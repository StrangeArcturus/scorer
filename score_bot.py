...
tegs: List[str] = ['text', 'audio', 'document', 'photo',
...
def helper(message):
    ...
    bot.send_message(message.from_user.id, (
        ...
        '-добавить -- добавляет в базу данных ваш предмет. Внимание, знак минуса (-) '
        'или восклицательный знак (!) в этой и в следующих командах обязателен!\n'
        f'{sp}Для работы с этой командой, её нужно писать в формате "-добавить <название предмета>", '
        f'через пробел и жеталельно без лишних слов!\n'
        ...
        '-очистить -- безвозвратно стирает оценки по выбранному предмету, но не удаляет его. '
        'Пример -- "-очистить инфа"\n'
